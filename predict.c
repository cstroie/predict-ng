...
int indx, antfd, iaz, iel, ma256, isplat, isplong, socket_flag = 0, Flags =
    0;
...
double ThetaG(double epoch, deep_arg_t * deep_arg)
{
  ...
  GMST =
      24110.54841 + TU * (8640184.812866 + TU * (0.093104 - TU * 6.2E-6));
...
void SGP4(double tsince, tle_t * tle, vector_t * pos, vector_t * vel)
{
  ...
  if (isFlagClear(SGP4_INITIALIZED_FLAG)) {
    ...
    ao = a1 * (1.0 -
               del1 * (0.5 * tothrd + del1 * (1.0 + 134.0 / 81.0 * del1)));
    ...
    xmdot =
        xnodp + 0.5 * temp1 * betao * x3thm1 +
        0.0625 * temp2 * betao * (13 - 78 * theta2 + 137 * theta4);
    x1m5th = 1 - 5 * theta2;
    omgdot =
        -0.5 * temp1 * x1m5th + 0.0625 * temp2 * (7 - 114 * theta2 +
                                                  395 * theta4) +
        temp3 * (3 - 36 * theta2 + 49 * theta4);
    xhdot1 = -temp1 * cosio;
    xnodot =
        xhdot1 + (0.5 * temp2 * (4 - 19 * theta2) +
  ...
  case dpinit:                 /* Entrance for deep space initialization */
    ...
    if (!((xnq < 0.0052359877) && (xnq > 0.0034906585))) {
      ...
      if (eq <= 0.65) {
        ...
        g310 =
            -19.302 + 117.390 * eq - 228.419 * deep_arg->eosq +
            156.591 * eoc;
        g322 =
            -18.9068 + 109.7927 * eq - 214.6334 * deep_arg->eosq +
            146.5816 * eoc;
        g410 =
            -41.122 + 242.694 * eq - 471.094 * deep_arg->eosq +
            313.953 * eoc;
        g422 =
            -146.407 + 841.880 * eq - 1629.014 * deep_arg->eosq +
            1083.435 * eoc;
        g520 =
            -532.114 + 3017.977 * eq - 5740 * deep_arg->eosq +
            3708.276 * eoc;
      }

      else {
        g211 =
            -72.099 + 331.819 * eq - 508.738 * deep_arg->eosq +
            266.724 * eoc;
        g310 =
            -346.844 + 1582.851 * eq - 2415.925 * deep_arg->eosq +
            1246.113 * eoc;
        g322 =
            -342.585 + 1554.908 * eq - 2366.899 * deep_arg->eosq +
            1215.972 * eoc;
        g410 =
            -1052.797 + 4758.686 * eq - 7193.992 * deep_arg->eosq +
            3651.957 * eoc;
        g422 =
            -3581.69 + 16178.11 * eq - 24462.77 * deep_arg->eosq +
            12422.52 * eoc;
        ...
        if (eq <= 0.715)
          ...
          g520 =
              -5149.66 + 29936.92 * eq -
              54087.36 * deep_arg->eosq + 31324.56 * eoc;
      }

      if (eq < 0.7) {
        g533 =
            -919.2277 + 4988.61 * eq - 9064.77 * deep_arg->eosq +
            5542.21 * eoc;
        g521 =
            -822.71072 + 4568.6173 * eq - 8491.4146 * deep_arg->eosq +
            5337.524 * eoc;
        g532 =
            -853.666 + 4690.25 * eq - 8624.77 * deep_arg->eosq +
            5341.4 * eoc;
      }

      else {
        g533 =
            -37995.78 + 161616.52 * eq -
            229838.2 * deep_arg->eosq + 109377.94 * eoc;
        g521 =
            -51752.104 + 218913.95 * eq -
            309468.16 * deep_arg->eosq + 146349.42 * eoc;
        g532 =
            -40023.88 + 170470.89 * eq -
            242699.48 * deep_arg->eosq + 115605.82 * eoc;
      }
      ...
      f221 = 1.5 * sini2;
      f321 =
          1.875 * deep_arg->sinio * (1 - 2 * deep_arg->cosio -
                                     3 * deep_arg->theta2);
      f322 =
          -1.875 * deep_arg->sinio * (1 + 2 * deep_arg->cosio -
                                      3 * deep_arg->theta2);
      ...
      f522 =
          9.84375 * deep_arg->sinio * (sini2 *
                                       ...
                                       0.33333333 * (-2 +
                                                     ...
                                                     deep_arg->theta2));
      f523 =
          deep_arg->sinio * (4.92187512 * sini2 *
                             (-2 - 4 * deep_arg->cosio +
                              10 * deep_arg->theta2) + 6.56250012 * (1 +
                                                                     2 *
                                                                     deep_arg->
                                                                     cosio
                                                                     -
                                                                     ...
                                                                     theta2));
      f542 =
          29.53125 * deep_arg->sinio * (2 - 8 * deep_arg->cosio +
                                        deep_arg->theta2 * (-12 +
                                                            8 *
                                                            deep_arg->
                                                            cosio +
      ...
      bfact =
          deep_arg->xmdot + deep_arg->xnodot + deep_arg->xnodot - thdt -
          thdt;
      ...
      f311 =
          0.9375 * deep_arg->sinio * deep_arg->sinio * (1 +
                                                        3 *
                                                        deep_arg->cosio) -
    ...
    do {
      ...
      do {
        ...
        if (isFlagSet(SYNCHRONOUS_FLAG)) {
          ...
          xnddt =
              del1 * cos(xli - fasx2) + 2 * del2 * cos(2 * (xli - fasx4)) +
          ...
          x2li = xli + xli;
          xndot =
              d2201 * sin(x2omi + xli - g22) + d2211 * sin(xli -
                                                           g22) +
              d3210 * sin(xomi + xli - g32) + d3222 * sin(-xomi +
                                                          xli -
                                                          g32) +
              d4410 * sin(x2omi + x2li - g44) +
              d4422 * sin(x2li - g44) + d5220 * sin(xomi + xli -
                                                    g52) +
              d5232 * sin(-xomi + xli - g52) + d5421 * sin(xomi +
                                                           x2li -
                                                           g54) +
              d5433 * sin(-xomi + x2li - g54);
          xnddt =
              d2201 * cos(x2omi + xli - g22) + d2211 * cos(xli -
                                                           g22) +
              d3210 * cos(xomi + xli - g32) + d3222 * cos(-xomi +
                                                          xli -
                                                          g32) +
              d5220 * cos(xomi + xli - g52) + d5232 * cos(-xomi +
                                                          xli -
                                                          g52) +
              2 * (d4410 * cos(x2omi + x2li - g44) +
                   d4422 * cos(x2li - g44) + d5421 * cos(xomi +
                                                         x2li -
                                                         g54) +
      ...
      while (isFlagSet(DO_LOOP_FLAG)
             && isFlagClear(EPOCH_RESTART_FLAG));
    }
...
void SDP4(double tsince, tle_t * tle, vector_t * pos, vector_t * vel)
{
  ...
  static double x3thm1, c1, x1mth2, c4, xnodcf, t2cof, xlcof, aycof,
      x7thm1;
  ...
  if (isFlagClear(SDP4_INITIALIZED_FLAG)) {
    ...
    del1 =
        1.5 * ck2 * x3thm1 / (a1 * a1 * deep_arg.betao * deep_arg.betao2);
    ao = a1 * (1 - del1 * (0.5 * tothrd + del1 * (1 + 134 / 81 * del1)));
    delo =
        1.5 * ck2 * x3thm1 / (ao * ao * deep_arg.betao * deep_arg.betao2);
    ...
    pinvsq =
        1 / (deep_arg.aodp * deep_arg.aodp * deep_arg.betao2 *
             deep_arg.betao2);
    ...
    coef = qoms24 * pow(tsi, 4);
    coef1 = coef / pow(psisq, 3.5);
    c2 = coef1 * deep_arg.xnodp * (deep_arg.aodp *
                                   (1 + 1.5 * etasq +
                                    eeta * (4 + etasq)) +
    ...
    deep_arg.xmdot =
        deep_arg.xnodp + 0.5 * temp1 * deep_arg.betao * x3thm1 +
        0.0625 * temp2 * deep_arg.betao * (13 - 78 * deep_arg.theta2 +
                                           137 * theta4);
    x1m5th = 1 - 5 * deep_arg.theta2;
    deep_arg.omgdot =
        -0.5 * temp1 * x1m5th + 0.0625 * temp2 * (7 -
                                                  114 *
                                                  deep_arg.theta2 +
                                                  395 * theta4) +
...
void
Calculate_User_PosVel(double time, geodetic_t * geodetic,
...
void Calculate_LatLonAlt(double time, vector_t * pos,
                         geodetic_t * geodetic)
{
...
void
Calculate_Obs(double time, vector_t * pos, vector_t * vel,
              geodetic_t * geodetic, vector_t * obs_set)
{
  ...
  top_s =
      sin_lat * cos_theta * range.x + sin_lat * sin_theta * range.y -
      cos_lat * range.z;
  top_e = -sin_theta * range.x + cos_theta * range.y;
  top_z =
      cos_lat * cos_theta * range.x + cos_lat * sin_theta * range.y +
      sin_lat * range.z;
...
void
Calculate_RADec(double time, vector_t * pos, vector_t * vel,
                geodetic_t * geodetic, vector_t * obs_set)
{
...
void socket_server(char *predict_name)
{
  ...
  while (1) {
    ...
    if ((n =
         recvfrom(sock, buf, sizeof(buf), 0, (struct sockaddr *) &fsin,
                  &alen)) < 0)
      exit(-1);
    ...
    if ((strncmp("GET_SAT", buf, 7) == 0)
      ...
      for (i = 0; i < 24; i++) {
        if ((strncmp(satname, sat[i].name, 25) == 0)
          ...
          sprintf(buff,
                  "%s\n%-7.2f\n%+-6.2f\n%-7.2f\n%+-6.2f\n%ld\n%-7.2f\n%-7.2f\n%-7.2f\n%-7.2f\n%ld\n%c\n%-7.2f\n%-7.2f\n%-7.2f\n",
                  sat[i].name, long_array[i], lat_array[i],
                  az_array[i], el_array[i], nxtevt,
                  footprint_array[i], range_array[i],
                  altitude_array[i], velocity_array[i],
                  orbitnum_array[i], visibility_array[i],
                  phase_array[i], eclipse_depth_array[i], squint_array[i]);
    ...
    if (strncmp("GET_QTH", buf, 7) == 0) {
      buff[0] = 0;
      sprintf(buff, "%s\n%g\n%g\n%d\n", qth.callsign, qth.stnlat,
              qth.stnlong, qth.stnalt);
      sendto(sock, buff, strlen(buff), 0, (struct sockaddr *) &fsin,
             sizeof(fsin));
      ok = 1;
    }
...
char KepCheck(char *line1, char *line2)
{
  ...
  x = (val[(int) line1[68]] ^ (sum1 % 10)) | (val[(int) line2[68]] ^
                                              (sum2 %
                                               10)) | (line1[0] ^ '1') |
      (line1[1] ^ ' ') | (line1[7] ^ 'U') | (line1[8] ^ ' ') | (line1[17]
                                                                ^ ' ')
      | (line1[23] ^ '.') | (line1[32] ^ ' ') | (line1[34] ^ '.') |
      (line1[43] ^ ' ') | (line1[52] ^ ' ') | (line1[61] ^ ' ') |
      (line1[62] ^ '0') | (line1[63] ^ ' ') | (line2[0] ^ '2') |
      (line2[1] ^ ' ') | (line2[7] ^ ' ') | (line2[11] ^ '.')
      | (line2[16] ^ ' ') | (line2[20] ^ '.') | (line2[25] ^ ' ') |
      (line2[33] ^ ' ') | (line2[37] ^ '.') | (line2[42] ^ ' ') |
      (line2[46] ^ '.') | (line2[51] ^ ' ') | (line2[54] ^ '.') |
      (line1[2] ^ line2[2]) | (line1[3] ^ line2[3]) | (line1[4] ^
                                                       line2[4]) |
      (line1[5] ^ line2[5]) | (line1[6] ^ line2[6]) | (isdigit(line1[68])
                                                       ? 0 : 1) |
...
double ReadBearing(char *input)
{
  ...
  if (b == 2) {                 /* Degree, Minute, Second Format (74 14 48) */
    ...
    bearing =
        (double) degrees + ((double) minutes / 60) + (seconds / 3600);
  }
    ...
    if (fd != NULL) {
      ...
      do {
        if (KepCheck(str1, str2)) {
          ...
          for (i = 0;
               (i < 24 && sat[i].catnum != atol(SubString(line1, 2, 6)));
               i++);
          ...
          if (i != 24) {
            ...
            tle_epoch =
                (float) atof(SubString(line1, 20, 31)) +
                (tle_year * 365.25);
      ...
      if (interactive) {
        ...
        if (kepcount == 1)
          ...
          mvprintw(18, 21, "%3u NASA Two Line Elements were read.",
                   kepcount);
        ...
        if (saveflag) {
          if (savecount == 1)
            ...
            if (savecount == 24)
              ...
              mvprintw(19, 21,
                       "%3u out of 24 satellites were updated.",
                       savecount);
          }
        }
...
int Select()
{
  ...
  for (x = 0, y = 8, z = 16; y < 16; ++x, ++y, ++z) {
    mvprintw(4 + x, 1, "[%c]: %-15s", x + 'A',
             Abbreviate(sat[x].name, 15));
    mvprintw(4 + x, 28, "[%c]: %-15s", y + 'A',
             Abbreviate(sat[y].name, 15));
    mvprintw(4 + x, 55, "[%c]: %-15s", z + 'A',
             Abbreviate(sat[z].name, 15));
  }
...
double GetStartTime(char mode)
{
  ...
  do {
    ...
    /* Month */
    good = (good && isalpha(line[2]) && isalpha(line[3])
            && isalpha(line[4])) ? 1 : 0;

    /* Year */
    good = (good && isdigit(line[5]) && isdigit(line[6])
            && (line[7] == ' ')) ? 1 : 0;

    /* Hour */
    good = (good && isdigit(line[8]) && isdigit(line[9])
            && (line[10] == ':')) ? 1 : 0;

    /* Minute */
    good = (good && isdigit(line[11]) && isdigit(line[12])
            && (line[13] == ':')) ? 1 : 0;
...
void FindMoon(double daynum)
{
  ...
  double jd, ss, t, t1, t2, t3, d, ff, l1, m, m1, ex, om, l,
      b, w1, w2, bt, p, lm, h, ra, dec, z, ob, n, el, az, teg, th, mm, dv;
  ...
  l = l + ex * 0.045874 * sin(2.0 * d - m) + ex * 0.041024 * sin(m1 -
                                                                 m) -
      0.034718 * sin(d);
  l = l - ex * 0.030465 * sin(m + m1) + 0.015326 * sin(2.0 * d -
                                                       2.0 * ff) -
      0.012528 * sin(2.0 * ff + m1);

  l = l - 0.01098 * sin(2.0 * ff - m1) + 0.010674 * sin(4.0 * d - m1) +
      0.010034 * sin(3.0 * m1);
  l = l + 0.008548 * sin(4.0 * d - 2.0 * m1) - ex * 0.00791 * sin(m -
                                                                  m1 +
                                                                  2.0 *
                                                                  d) -
  ...
  l = l + ex * 0.002695 * sin(2.0 * m1 - m) + 0.002602 * sin(m1 -
                                                             2.0 * ff -
                                                             2.0 * d) +
      ex * 0.002396 * sin(2.0 * d - m - 2.0 * m1);

  l = l - 0.002349 * sin(m1 + d) + ex * ex * 0.002249 * sin(2.0 * d -
                                                            2.0 * m) -
  ...
  l = l + ex * 0.00122 * sin(4.0 * d - m - m1) - 0.00111 * sin(2.0 * m1 +
                                                               2.0 *
                                                               ff) +
      0.000892 * sin(m1 - 3.0 * d);
  ...
  l = l + ex * ex * 0.000704 * sin(m1 - 2.0 * m - 2.0 * d) +
      ...
      ex * 0.000598 * sin(2.0 * d - m - 2.0 * ff) + 0.00055 * sin(m1 +
                                                                  4.0 * d);
  ...
  b = b + 0.055413 * sin(2.0 * d + ff - m1) + 0.046272 * sin(2.0 * d -
                                                             ff - m1) +
      0.032573 * sin(2.0 * d + ff);

  b = b + 0.017198 * sin(2.0 * m1 + ff) + 9.266999e-03 * sin(2.0 * d +
                                                             m1 - ff) +
      0.008823 * sin(2.0 * m1 - ff);
  b = b + ex * 0.008247 * sin(2.0 * d - m - ff) +
      0.004323 * sin(2.0 * d - ff - 2.0 * m1) + 0.0042 * sin(2.0 * d + ff +
                                                             m1);
  ...
  b = b - ex * 0.001803 * sin(ff + m) - 0.00175 * sin(3.0 * ff) +
      ...
      ex * 0.001481 * sin(ff + m + m1) + ex * 0.001417 * sin(ff - m -
                                                             m1) +
  ...
  b = b + 0.000439 * sin(3.0 * m1 - ff) + 0.000423 * sin(ff + 2.0 * d +
                                                         2.0 * m1) +
  ...
  p = p + 0.000173 * cos(3.0 * m1) + 0.000167 * cos(4.0 * d - m1) -
      ...
      0.000084 * cos(2.0 * m1 - 2.0 * d) - ex * 0.000083 * cos(2.0 * d +
                                                               m) +
      0.000079 * cos(2.0 * d + 2.0 * m1);

  p = p + 0.000072 * cos(4.0 * d) + ex * 0.000064 * cos(2.0 * d - m +
                                                        m1) -
      ex * 0.000063 * cos(2.0 * d + m - m1);

  p = p + ex * 0.000041 * cos(m + d) + ex * 0.000035 * cos(2.0 * m1 -
                                                           m) -
...
void Calc()
{
  ...
  rv = (long) floor((tle.xno * xmnpda / twopi + age * tle.bstar * ae) *
...
char Decayed(int x, double time)
{
  ...
  if (satepoch +
      ((16.666666 - sat[x].meanmo) / (10.0 * fabs(sat[x].drag))) < time)
    return 1;
  else
    return 0;
}
...
int Print(char *string, char mode)
{
  ...
  if (string[0] == 0) {
    ...
    if (mode != 'm' && mode != 'o') {
      ...
      sprintf(head1, "\n%s%s's %s Calendar For %s", spaces,
              qth.callsign, type, satellite_name);
...
void Predict(char mode)
{
  ...
  if (AosHappens(indx) && Geostationary(indx) == 0
      ...
      while (iel >= 0 && quit == 0) {
        if (calc_squint)
          sprintf(string,
                  ...
                  (io_lat == 'N' ? +1 : -1) * isplat,
                  (io_lon == 'W' ? 360 - isplong : isplong), irk,
                  squint, findsun);
          ...
          sprintf(string,
                  ...
                  Daynum2String(daynum), iel, iaz, ma256,
                  (io_lat == 'N' ? +1 : -1) * isplat,
                  (io_lon == 'W' ? 360 - isplong : isplong), irk, rv,
                  findsun);
    ...
    if (Geostationary(indx) == 1)
      mvprintw(12, 3,
               "*** Orbital predictions cannot be made for a geostationary satellite! ***\n");
...
void PredictMoon()
{
  ...
  if (xterm)
    fprintf(stderr,
            "\033]0;PREDICT: %s's Orbit Calendar for the Moon\007",
            qth.callsign);
  ...
  do {
    ...
    do {
      ...
      sprintf(string,
              "      %s%4d %4d  %5.1f  %5.1f  %5.1f  %6.1f%7.3f\n",
              Daynum2String(daynum), iel, iaz, moon_ra, moon_dec,
              moon_gha, moon_dv, moon_dx);
      quit = Print(string, 'm');
      lastel = iel;
      lastdaynum = daynum;
...
void PredictSun()
{
  ...
  if (xterm)
    fprintf(stderr,
            "\033]0;PREDICT: %s's Orbit Calendar for the Sun\007",
            qth.callsign);
  ...
  do {
    ...
    do {
      ...
      sprintf(string,
              "      %s%4d %4d  %5.1f  %5.1f  %5.1f  %6.1f%7.3f\n",
              Daynum2String(daynum), iel, iaz, sun_ra, sun_dec,
              sun_lon, sun_range_rate, sun_range);
      quit = Print(string, 'o');
      lastel = iel;
      lastdaynum = daynum;
...
void ShowOrbitData()
{
  ...
  while (x != -1) {
    if (sat[x].meanmo != 0.0) {
      ...
      no_period =
          (an_period * 360.0) / (360.0 +
                                 (4.97 * pow((xkmper / sma), 3.5) *
                                  ((5.0 * c1 * c1) -
                                   1.0) / (e2 * e2)) / sat[x].meanmo);
      satepoch = DayNum(1, 0, sat[x].year) + sat[x].refepoch;
...
void QthEdit()
{
  ...
  if (io_lat == 'N')
    mvprintw(18, 12,
             "Enter your latitude in degrees NORTH  (south=negative) ");
  else
    mvprintw(18, 12,
             "Enter your latitude in degrees SOUTH  (north=negative) ");
  ...
  if (io_lon == 'W')
    mvprintw(18, 12,
             "Enter your longitude in degrees WEST   (east=positive) ");
  else
    mvprintw(18, 12,
             "Enter your longitude in degrees EAST   (west=negative) ");
  ...
  clrtoeol();
  mvprintw(18, 12,
           "    Enter your altitude above sea level (in meters)   ");
...
void SingleTrack(int x, char speak)
{
  ...
  mvprintw(5 + tshift, 1 + xo,
           "Satellite     Direction     Velocity     Footprint    Altitude     Slant Range");
  mvprintw(6 + tshift, 1 + xo,
           "---------     ---------     --------     ---------    --------     -----------");
  mvprintw(7 + tshift, 1 + xo,
           "        .            Az           mi            mi          mi              mi");
  mvprintw(8 + tshift, 1 + xo,
           "        .            El           km            km          km              km");
  mvprintw(16 + bshift, 1 + xo,
  ...
  do {
    ...
    mvprintw(18 + bshift, 3 + xo, "%+6.2f%c  ", eclipse_depth / deg2rad,
             176);
    ...
    if (sat_ele >= 0.0) {
      ...
      if (comsat) {
        ...
        if (downlink != 0.0) {
          ...
          loss =
              32.4 + (20.0 * log10(downlink)) + (20.0 * log10(sat_range));
...
void MultiTrack()
{
  ...
  double aos[24], aos2[24], temptime, nextcalctime =
      0.0, los[24], aoslos[24];
  ...
  for (x = 0; x < 24; x++) {
    if (Geostationary(x) == 0 && AosHappens(x) == 1
        && Decayed(x, 0.0) != 1)
      ok2predict[x] = 1;
    else
      ok2predict[x] = 0;
    ...
    for (z = 0; z < 24; z++) {
      ...
      if (sat[indx].meanmo != 0.0 && Decayed(indx, 0.0) != 1) {
        ...
        if (socket_flag) {
          ...
          doppler[indx] =
              -100e06 * ((sat_range_rate * 1000.0) / 299792458.0);
        ...
        if (ok2predict[indx] && daynum > los[indx]
            && inrange[indx])
          los[indx] = FindLOS2();
    ...
    if (daynum > nextcalctime) {
      ...
      for (x = 0, y = 0, z = -1; x < 21 && y != 3; x++) {
        if (ok2predict[satindex[x]] && aos2[x] != 0.0) {
          mvprintw(y + 21, 19 + xo, "%10s on %s UTC",
...
void Illumination()
{
  ...
  do {
    ...
    datestring[11] = 0;
    sprintf(string1, "      %s    %4d    %6.2f%c", datestring,
...
void NewUser()
{
  ...
  mvprintw(12, 2,
           "WELCOME to PREDICT!  Since you are a new user to the program, default\n");
  printw
      ("  orbital data and ground station location information was copied into\n");
  printw
      ("  your home directory to get you going.  Please select option [G] from\n");
  printw
      ("  PREDICT's main menu to edit your ground station information, and update\n");
  printw
      ("  your orbital database using option [U] or [E].  Enjoy the program!  :-)");
  refresh();
  ...
  if (CopyFile(temp, tlefile))
    printw
        ("\n\n  *** ERROR: Could not copy default TLE file from \"%s\"!",
         temp);
  ...
  if (CopyFile(temp, dbfile))
    printw
        ("\n\n  *** ERROR: Could not copy default DB file from \"%s\"!",
         temp);
  ...
  if (CopyFile(temp, qthfile))
    printw
        ("\n\n  *** ERROR: Could not copy default QTH file from \"%s\"!",
         temp);
  ...
  for (z = 0; z < 24; z++) {
    if ((strcmp(sat[z].name, satname) == 0)
      ...
      fprintf(fd, "%-10s %-19s %4s %4s %4s %4s %4s %6s %6s %s\n",
              "Timestamp", "UTC Date/Time", "El", "Az", "MA", "Lat",
              "Lon", "Range", "Orbit", "Sun");
      ...
      if ((start >= now - 31557600) && (start <= now + 31557600)
        ...
        if (Decayed(indx, daynum) == 0)
          fprintf(fd,
                  "%ld %s %4d %4d %4d %4d %4d %6ld %6ld %c\n",
                  start, Daynum2String(daynum), iel, iaz, ma256,
                  isplat, isplong, irk, rv, findsun);
        break;
      }
        ...
        for (count = start; count <= end; count += step) {
          ...
          if (Decayed(indx, daynum) == 0)
            fprintf(fd,
                    "%ld %s %4d %4d %4d %4d %4d %6ld %6ld %c\n",
                    count, Daynum2String(daynum), iel, iaz,
                    ma256, isplat, isplong, irk, rv, findsun);
        }
        break;
      }
    }
...
int QuickPasses(char *outputfile, char *filter)
{
  ...
  for (i = 0; i < 24; i++) {
    ...
    while (daynum < limit && daynum > 0.0) {
      ...
      if (aos < limit && maxel >= min_elevation
          && npass < (int) (sizeof(passes) / sizeof(passes[0]))) {
        ...
        if (AosHappens(indx) && Geostationary(indx) == 0
          ...
          while (sat_ele >= 0.0) {
            if (sat_ele > passmax)
              passmax = sat_ele;
            daynum +=
                cos((sat_ele - 1.0) * deg2rad) * sqrt(sat_alt) / 25000.0;
            Calc();
          }
          ...
          if (passmax >= min_elevation) {
            ...
            Calc();
            fprintf(fd,
                    "%-10s %-19s %4s %4s %4s %4s %4s %6s %6s %s %s\n",
                    "Timestamp", "UTC Date/Time", "El", "Az",
                    "MA", "Lat", "Lon", "Range", "Orbit", "Sun",
                    "Doppler100");

            while (iel >= 0) {
              fprintf(fd,
                      "%.0f %s %4d %4d %4d %4d %4d %6ld %6ld %c %f\n",
                      floor(86400.0 * (3651.0 + daynum)),
                      Daynum2String(daynum), iel, iaz, ma256,
                      isplat, isplong, irk, rv, findsun, doppler100);
              lastel = iel;
              daynum +=
                  cos((sat_ele - 1.0) * deg2rad) * sqrt(sat_alt) / 25000.0;
              Calc();
    ...
    if ((strcmp(sat[z].name, satname) == 0)
      ...
      if ((start >= now - 31557600) && (start <= now + 31557600)) {
        ...
        if (AosHappens(indx) && Geostationary(indx) == 0
          ...
          while (iel >= 0) {
            doppler100 =
                -100.0e06 * ((sat_range_rate * 1000.0) / 299792458.0);
            fprintf(fd, "%.0f,%s,%f\n", floor(86400.0 * (3651.0 + daynum)),
                    Daynum2String(daynum), doppler100);
            lastel = iel;
            daynum +=
                cos((sat_ele - 1.0) * deg2rad) * sqrt(sat_alt) / 500000.0;
            Calc();
          }
...
int main(int argc, char *argv[])
{
  ...
  for (x = 1; x <= y; x++) {
    ...
    if (strcmp(argv[x], "-h") == 0 || strcmp(argv[x], "--help") == 0) {
      printf
          ("predict-ng v%s - satellite tracking and orbital prediction\n\n",
           VERSION);
      ...
      printf
          ("  -u <file> [...]  Update orbital database from TLE file(s) and exit\n");
      printf
          ("  -P               List all passes in the next 24h (sorted by AOS)\n");
      printf
          ("  -e <degrees>     Minimum elevation threshold (default: 0)\n");
      printf
          ("  -f <sat> <start> [end]  Satellite position(s) at Unix time(s)\n");
      ...
      printf
          ("  -n <port>        Use alternate UDP port (default: 1210)\n\n");
      printf("Antenna rotator:\n");
      printf("  -a <port>        Send AZ/EL to serial port (on change)\n");
      printf
          ("  -a1 <port>       Send AZ/EL to serial port (every second)\n\n");
      printf("Display:\n");
  ...
  if (x == 3) {                 /* Both TLE and QTH files were loaded successfully */
    ...
    if (tle_cli[0] || qth_cli[0]) {
      ...
      if (x ^ 1)
        printf
            ("*** ERROR!  Your QTH file \"%s\" could not be loaded!\n",
             qthfile);

      if (x ^ 2)
        printf
            ("*** ERROR!  Your TLE file \"%s\" could not be loaded!\n",
             tlefile);
  ...
  if (x == 3) {
    ...
    if (socket_flag) {
      pthread_create(&thread, NULL, (void *) socket_server,
                     (void *) argv[0]);
      bkgdset(COLOR_PAIR(3));
      MultiTrack();
    }
